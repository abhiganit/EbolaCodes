function EbolaModelRunVaccTx_delay183()
   % Add current paramest.mat file from Fitting folder
    tic;  
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%% NO INTERVENTION %%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%rm %%%%%%%%%%%%%%%%%%%%%
...
% Initial conditions
    ...
    % no intervention
    modelout = EbolaModel(1, x, timesets, duration, ic, 1, MaxIt, delayuntilintervention, delayuntilimmunity, 0, 0, 0, 0);
    %save outcomes
    ...
    for VESuccess = allVSuccess
        indexVESuccess = indexVESuccess+1;
            modelout = EbolaModel(1, x, timesets, duration, ic, 1, MaxIt, delayuntilintervention, delayuntilimmunity, VESuccess, 1, 0, 0);
            %save outcomes
    ...
    allTCov = linspace(0.2,1,5);
        ...
        for TE = allTE
            ...
            for TCov = allTCov 
                ...
                modelout = EbolaModel(1, x, timesets, duration, ic, 1, MaxIt, delayuntilintervention, delayuntilimmunity, 0, 0, TE, TCov);
                %save outcomes
    ...
    save('VaccTreatmentStochResults_delay91_Det_rho30',... 
