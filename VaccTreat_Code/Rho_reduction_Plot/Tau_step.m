...
% Hosp: susc -> exposed
Rate(3) = betaH*Sh*(Ih+Iht+Iw+Iwt+0.7*T)/(Nh+Nw);      Change(3,3) = -1; Change(3,6) = +1;  %could we have transmissibility between hospitalized patients be same as in general popn?
% Worker: susc -> exposed
Rate(4) = betaW*Sw*(Ih+Iht+Iw+Iwt+0.7*T)/(Nh+Nw);      Change(4,4) = -1; Change(4,7) = +1;
