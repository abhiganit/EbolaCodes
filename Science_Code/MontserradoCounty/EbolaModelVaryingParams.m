function modelout = EbolaModelVaryingParams(model, x, timepoints, MaxTime, initial,ControlParams)
...
%             output.CHosp = pop(:,27);
           ...
           %% OUTPUT
            ...
            %% SAVE OUTPUT
            CumulativeCases = output(:,20) + output(:,21) + output(:,22);
