function modelout = EbolaModel(model, x,y, timepoints, MaxTime, initial, HospitalVisitors, MaxIt, interventiondelay, immunitydelay, VE, VCov, TE, TCov)
...
% equation.
    ...
    omega = y(9);        % overall funeral risk relative to general population
