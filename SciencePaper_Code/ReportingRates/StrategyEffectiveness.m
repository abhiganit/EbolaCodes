...
Adet = input;
load('StochasticRunsData');  %load stochastic simulation data
...
legendtitle = {'Community Transmission Reduction','','', ...
               'Hygienic Burial of Hospital Cases','Hygienic Burial of Community Cases','Hospital Contacts Follow-up/Isolation'};              
