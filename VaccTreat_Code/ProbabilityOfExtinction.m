function[ProbCell,ThresholdEffandCov3months,ThresholdEffandCov6months] = ProbabilityOfExtinction(input, sliceprob)
%INPUT:
...
for i = 1:p            % Looping over delays
    for j = 1:q        % Looping over efficacies
        for k = 1:r    % Looping over coverage
            ...
            month6 = sum(B(183,:)<1);  % # stochastic realizations resulting into < 1 daily ebola cases after 6 months
