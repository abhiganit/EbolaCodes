...
% Hosp: exposed -> inf
Rate(6) = epsilon*alpha*Eh;                                      Change(6,6) = -1; Change(6,28) = +1;
% Worker: exposed -> inf
Rate(7) = epsilon*alpha*Ew;                                      Change(7,7) = -1; Change(7,29) = +1;
...
% Hosp: susc -> exposed
% Rate(27) = betaH*Sh*(Ih+Iht+Iw+Iwt)/(Nh+Nw);      Change(27,22) = +1;  
Rate(27) = epsilon*alpha*Eh; ;      Change(27,22) = +1;  

% Worker: susc -> exposed
% Rate(28) = betaW*Sw*(Ih+Iht+Iw+Iwt)/(Nh+Nw);      Change(28,23) = +1;
...
Rate(33) = gammaH*Iht;                               Change(33,28) = -1;    Change(33,9) = +1;
Rate(34) = gammaH*Iwt;                               Change(34,29) = -1;    Change(34,10) = +1;

%% Intervention Rates
Rate(35) = iG*Ig;                                  Change(35,8) = -1;   Change(35,30) = +1;
Rate(36) = iH*Iht;                                 Change(36,28) = -1;  Change(36,30) = +1;
Rate(37) = iH*Iwt;                                 Change(37,29) = -1;  Change(37,30) = +1;
Rate(38) = iH*Ih;                                  Change(38,9) = -1;   Change(38,30) = +1;
Rate(39) = iH*Iw;                                  Change(39,10) = -1;   Change(39,30) = +1;
Rate(40) = C*phiC*epsilon*alpha*(Eg+Eh+Ew)*Eg/(Sg+Eg);   Change(40,5) = -1;   Change(40,31) = +1;
Rate(41) = alpha*epsilon*A;                        Change(41,31) = -1;  Change(41,30) = +1;
Rate(42) = pG*(1-theta)*gammaD*Ig;                 Change(42,8) = -1;   Change(42,17) = +1;
Rate(43) = pH*gammaDH*Ih;                          Change(43,9) = -1;   Change(43,18) = +1;
Rate(44) = pH*gammaDH*Iw;                          Change(44,10) = -1;  Change(44,19) = +1;
