...
function f = ErrorFunction(beta, timepoints, datapoints, maxtime, weights, initial, HospitalVisitors,y)
    
    % calculate model points
    model = EbolaModel(1, beta, timepoints, maxtime, initial,HospitalVisitors,10,y);
    modelfit = model{1};
