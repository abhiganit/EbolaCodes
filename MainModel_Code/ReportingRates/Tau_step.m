...
delta = Parameters(13); %delta2 = Parameters(14);
...
% General: inf -> funeral
Rate(28) = reportingrateGeneral*delta*((1-theta)*gammaD*Ig);                   Change(28,23) = +1; 
% Hosp: inf -> funeral
Rate(29) = reportingrateHospital*delta*(gammaDH*Ih);                            Change(29,24) = +1; 
% Worker: inf -> funeral
Rate(30) = reportingrateHospital*delta*(gammaDH*Iw);                            Change(30,25) = +1; 
