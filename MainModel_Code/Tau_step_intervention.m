...
iH = Parameters(24);  phiG = Parameters(25); phiW = Parameters(26);
phiC = Parameters(27); pG = Parameters(28); pH = Parameters(29);  C = Parameters(30); tau = Parameters(31);
...
% General: inf -> funeral
Rate(8) = (1-pG)*deltaG*(1-theta)*gammaD*Ig;                    		Change(8,8) = -1; Change(8,11) = +1;  
% Hosp: inf -> funeral
Rate(9) = (1-iH)*deltaH*(1-pH)*gammaDH*Ih;                            		Change(9,9) = -1; Change(9,12) = +1;  
% Worker: inf -> funeral
Rate(10) = (1-iH)*deltaH*(1-pH)*gammaDH*Iw;                            		Change(10,10) = -1; Change(10,13) = +1;

% General: inf -> recovered
Rate(11) = (1-deltaG)*gammaI*(1-theta)*Ig;               					Change(11,8) = -1; Change(11,14) = +1;  
% Hosp: inf -> recovered
Rate(12) = (1-deltaH)*gammaIH*Ih;                        					Change(12,9) = -1; Change(12,15) = +1; 
% Worker: inf -> recovered
Rate(13) = (1-deltaH)*gammaIH*Iw;                        					Change(13,10) = -1; Change(13,16) = +1;
...
Rate(17) = MF*(Nd/E +  (1-pG)*deltaG*(1-theta)*gammaD*Ig + (1-iH)*(1-pH)*deltaH*gammaDH*(Ih+Iw))*Sg/(Ng-Sf);           Change(17,1) = -1; Change(17,2) = +1;     
...
% General: inf -> funeral
Rate(28) = deltaG*(1-theta)*gammaD*Ig;                   Change(28,23) = +1;  
% Hosp: inf -> funeral
Rate(29) = deltaH*gammaDH*Ih;                            Change(29,24) = +1;  
% Worker: inf -> funeral
Rate(30) = deltaH*gammaDH*Iw;                            Change(30,25) = +1; 


%% Cumulative Hospitalizations (including HCW)
Rate(31) = gammaH*theta*Ig + gammaH*Iht + gammaH*Iwt;             Change(31,26) = +1;  
...
Rate(42) = ((1-iH)*pH+iH)*deltaH*gammaDH*Ih;                          Change(42,9) = -1;   Change(42,18) = +1;
%Rate(43) = ((1-iH)*pH+iH)*gammaDH*Iw;                          Change(43,10) = -1;  Change(43,19) = +1;
Rate(43) = ((1-iH)*pH+iH)*deltaH*gammaDH*Iw;                          Change(43,10) = -1;  Change(43,19) = +1;
