...
output = EbolaModel(1, estimatedvalues, alltimepoints, fittingplusvalidationtime, initial, HospitalVisitors, MaxIt)';
...
<<<<<<< HEAD:SciencePaper_Code/plotModelFit.m
    plot(validationdata(:,1), validationdata(:,i+1), '.b', 'MarkerSize', 14)
=======
%    plot(validationtimepts(:,i), validationdatapts(:,i), '.b', 'MarkerSize', 14)
>>>>>>> 56db39bd6e6985b9e9f5e9466c23d5a7a04824cd:VaccTreat_Code/Sensitivity Analysis/plotModelFit.m
