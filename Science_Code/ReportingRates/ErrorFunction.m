...
function f = ErrorFunction(beta, timepoints, datapoints, maxtime, weights, initial, HospitalVisitors, repG, repH)
    
    % calculate model points
    model = EbolaModel(1, beta, timepoints, maxtime, initial,HospitalVisitors, 1, repG, repH);
    modelfit = model{1};
