function EbolaModelRunVaccTx_delayDec_Clemson
% For Running on Palmetto. Should be same as EbolaModelRunVaccTx_delay182.
    tic; 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%% NO INTERVENTION %%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%               183 14];
    ...
    save('VaccTreatmentStochResults_delayDec',... 
        'cumulativecasesTX',...
        'cumulativedeathsTX',...
