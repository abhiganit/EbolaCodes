...
function f = ErrorFunction(beta, timepoints, datapoints, maxtime, weights, initial, ReportingRate, HospitalVisitors)
    
    % calculate model points
    model = EbolaModel(1, beta, timepoints, maxtime, initial, ReportingRate, HospitalVisitors);
    modelfit = model{1};
