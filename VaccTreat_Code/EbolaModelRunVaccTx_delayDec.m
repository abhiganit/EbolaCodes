function EbolaModelRunVaccTx_delayDec
    tic; 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%% NO INTERVENTION %%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     end
    ...
    %%%% No Intervention
    modelout = EbolaModel(0, EstimatedParameters(), timesets, duration, Initial(EstimatedParameters()), ReportingRate, HospitalVisitors, MaxIt, 0, 0, 0, 0, 0, 0);
    %save outcomes
    ...
    %for i = 1:size(delays,1)
        ...
        for TE = allTE
            ...
            for TCov = allTCov 
                ...
                modelout = EbolaModel(0, EstimatedParameters(), timesets, duration, Initial(EstimatedParameters()), ReportingRate, HospitalVisitors, MaxIt, delayuntilintervention, delayuntilimmunity, 0, 0, TE, TCov);
                %save outcomes
    ...
    save('VaccTreatmentStochResults_delay182',... 
        'cumulativecasesTX',...
        'cumulativedeathsTX',...
